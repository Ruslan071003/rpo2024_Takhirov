...
{
    switch (in) {
        case MBEDTLS_SSL_EARLY_DATA_STATUS_UNKNOWN:
            return "MBEDTLS_SSL_EARLY_DATA_STATUS_UNKNOWN";
        ...
        case MBEDTLS_SSL_EARLY_DATA_STATUS_SENT:
            return "MBEDTLS_SSL_EARLY_DATA_STATUS_SENT";
        case MBEDTLS_SSL_EARLY_DATA_STATUS_CAN_WRITE:
            return "MBEDTLS_SSL_EARLY_DATA_STATUS_CAN_WRITE";
        case MBEDTLS_SSL_EARLY_DATA_STATUS_SERVER_FINISHED_RECEIVED:
            return "MBEDTLS_SSL_EARLY_DATA_STATUS_SERVER_FINISHED_RECEIVED";
        default:
            return "UNKNOWN_VALUE";
    }
}
