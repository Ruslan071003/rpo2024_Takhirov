...
char *personalization = "my-mega-app";

#define LOG_INFO(...) __android_log_print(ANDROID_LOG_INFO, "android_ndk", __VA_ARGS__)
...
JNICALL
Java_ru_iu3_fclient2_MainActivity_log(JNIEnv *env, jobject ,jstring value/* this */){
...
Java_ru_iu3_fclient2_MainActivity_initRng(JNIEnv *env, jclass clazz) {
...
Java_ru_iu3_fclient2_MainActivity_randomBytes(JNIEnv *env, jclass clazz, jint no) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_fclient2_MainActivity_encrypt(JNIEnv *env, jclass clazz,jbyteArray key, jbyteArray data) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_ru_iu3_fclient2_MainActivity_decrypt(JNIEnv *env, jclass clazz,jbyteArray key, jbyteArray data) {
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
...
Java_ru_iu3_fclient2_MainActivity_transaction(JNIEnv *xenv, jobject xthiz, jbyteArray xtrd) {
